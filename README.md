...
| Year | Paper | Key Takeaways & Description |
| :--- | :---- | :-------------------------- |
| 2026 | [DEBT BEHIND THE AI BOOM: A LARGE-SCALE EMPIRICAL STUDY OF AI-GENERATED CODE IN THE WILD](https://www.alphaxiv.org/abs/2603.28592) | This large-scale empirical study analyzes 302.6K verified AI-authored commits from 6,299 GitHub repositories to attribute code smells, correctness, and security issues to five AI coding assistants and track each introduced issue to HEAD. The authors identify 484,366 distinct issues (89.3% code smells) and show that a substantial portion of AI-introduced debt persists over time. <br><br> _"22.7% of tracked AI-introduced issues still survive at the latest repository revision (HEAD), revealing persistent maintenance costs from AI-generated code."_ |
| 2026 | [Cybersecurity AI: A Game-Theoretic AI for Guiding Attack and Defense](https://www.alphaxiv.org/abs/2601.05887) | Introduces Generative Cut-the-Rope (G-CTR), a game-theoretic guidance layer that extracts attack graphs, computes effort-aware Nash equilibria, and feeds concise digests back into LLM agents to guide actions. Across real-world exercises and a 44-run cyber-range, G-CTR matches 70–90% of expert graph structure, runs 60–245x faster, increases success from 20.0% to 42.9%, reduces cost-per-success by 2.7x, and enables a Purple agent that outperforms LLM-only baselines. <br><br> _"This closed-loop guidance is what produces the breakthrough: it reduces ambiguity, collapses the LLM's search space, suppresses hallucinations, and keeps the model anchored to the most relevant parts of the problem, yielding large gains in success rate, consistency, and reliability."_ |
